...
}, "/bots"> & import("hono/types").MergeSchemaPath<{
    "/": {
        $post: {
            input: {
                json: {
...
}, "/user/reviews"> & import("hono/types").MergeSchemaPath<{
    "/": {
        $get: {
            input: {};
            output: {
...
}, "/reviews"> & import("hono/types").MergeSchemaPath<{
    "/career": {
        $get: {
            input: {};
            output: {
...
}, "/general"> & import("hono/types").MergeSchemaPath<{
    "/register": {
        $post: {
            input: {
                json: {
