...
export default function PageTitle({ children, size = "md", icon = false }: PageTitleProps) {
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      <h1
        className={`font-bold text-gray-900 dark:text-white ${sizeClasses[size]} relative transition-all duration-300 hover:text-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-hidden dark:hover:text-blue-400`}
      >
        {children}
