...
export default function TableCourseCampuses({ campus, lastSemester, variant = "default" }: TableCourseCampusesProps) {
        ...
        <Pill variant={pillVariant}>
            <div className="flex flex-col">
                ...
                <div className="flex items-center gap-1">
                    {variant === "with-icon" && <LocationIcon className="w-3 h-3" />}
