							...
							<NavigationMenuList>
								<NavigationMenuItem>
									<NavigationMenuLink asChild className={navigationMenuTriggerStyle()}>
										<a href="/catalog" className="hover:bg-primary-light hover:text-primary">
											CATÁLOGO
										</a>
									</NavigationMenuLink>
								</NavigationMenuItem>
								<NavigationMenuItem>
									<NavigationMenuLink asChild className={navigationMenuTriggerStyle()}>
										<a href="/horario" className="hover:bg-primary-light hover:text-primary">
											HORARIO
										</a>
									</NavigationMenuLink>
								</NavigationMenuItem>
										...
										<ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
											<li className="row-span-3">
												<NavigationMenuLink asChild>
													<a
														className="from-background to-primary-foreground hover:to-primary flex h-full w-full flex-col justify-end rounded-md bg-radial from-80% p-6 no-underline outline-none select-none focus:shadow-md"
														href="https://osuc.dev"
													>
														...
														<p className="text-sm leading-tight">
															La comunidad estudiantil de innovación y desarrollo de software de la
															UC.
														</p>
													</a>
												</NavigationMenuLink>
					...
					<div className="flex w-full items-center justify-between">
						<div className="flex gap-2">
							...
							<ButtonNavbar
								...
								url="https://registration9.uc.cl/StudentRegistrationSsb/ssb/registration"
							/>
						</div>
