  ...
  "inline-flex items-center rounded-lg border font-medium",
  {
    variants: {
      variant: {
        ...
        schedule_blue: "bg-primary-foreground text-primary border-primary/20 rounded-md",
        schedule_pink: "bg-pink-light text-pink border-pink/20 rounded-md",
        schedule_green: "bg-green-light text-green border-green/20 rounded-md",
        schedule_purple: "bg-purple-light text-purple border-purple/20 rounded-md",
        schedule_orange: "bg-orange-light text-orange border-orange/20 rounded-md",
        schedule_red: "bg-red-light text-red border-red/20 rounded-md",
      },
      size: {
