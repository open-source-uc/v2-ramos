...
export default function DarkThemeToggle() {
	...
	return (
		<button
			...
			className="tablet:w-auto bg-background text-input border-border hover:bg-primary-foreground hover:text-primary hover:border-primary focus:ring-ring w-full rounded-lg border-1 px-4 py-1.5 text-xs transition-colors duration-200 focus:ring-2 focus:ring-offset-2 focus:outline-none"
		...
		>
			<div className="flex items-center justify-center space-x-2">
				...
				<span className="text-nowrap">{isDarkTheme ? 'TEMA CLARO' : 'TEMA OSCURO'}</span>
			</div>
		</button>
	)
}
