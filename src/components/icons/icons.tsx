...
export function CheckIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className={className}><path d="M382-245.69 159.23-468.46 205.77-515 382-338.77 756.23-713l46.54 46.54L382-245.69Z"/></svg>
  );
}
