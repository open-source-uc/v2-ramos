...
export function LoadingIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className={className}><path d="M479.76-88q-80.9 0-152.57-30.8-71.66-30.8-124.63-83.76-52.96-52.97-83.76-124.63Q88-398.86 88-479.76q0-80.96 30.92-152.95 30.93-71.98 83.66-124.71 52.73-52.73 124.67-83.66Q399.19-872 480-872q14.03 0 23.51 9.49 9.49 9.5 9.49 23.54 0 14.03-9.49 23.5Q494.03-806 480-806q-136 0-231 95t-95 231q0 136 95 231t231 95q136 0 231-95t95-231q0-14.06 9.5-23.53 9.49-9.47 23.53-9.47 14.03 0 23.5 9.49Q872-494.03 872-480q0 80.81-30.92 152.75-30.93 71.94-83.66 124.67-52.73 52.73-124.71 83.66Q560.72-88 479.76-88Z"/></svg>
  );
}

export function FixIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className={className}><path d="m700.15-133.69-254-254.46q-20.3 8.3-43.5 13.23-23.19 4.92-47.27 4.92-98.53 0-167.26-69.73-68.74-69.73-68.74-168.27 0-34 8.27-63.04T152-726.15l147.38 145.84 83.7-83.69-146.31-145.85q26.08-16.07 55.35-25.11 29.26-9.04 63.26-9.04 98.54 0 168.27 68.73T593.38-608q0 24.62-4.53 47.31-4.54 22.69-13.62 43.46l254.46 254q11.93 11.92 11.93 27.08 0 15.15-11.93 27.07l-74.92 76.93q-11.92 11.92-27.31 11.15-15.38-.77-27.31-12.69Z"/></svg>
  );
}

export function SwapIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className={className}><path d="M282.31-168.77 88-362.08l194.31-193.3 46.31 47.53-112.77 112.77h282.46v66H215.85l112.77 112.77-46.31 47.54Zm395.38-236.61-46.31-47.54 112.77-112.77H461.69v-66h282.46L631.38-744.46 677.69-792 872-598.69 677.69-405.38Z"/></svg>
  );
}

export function AlertIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className={className}><path d="M479.82-285.54q14.64 0 24.72-9.9 10.08-9.9 10.08-24.54 0-14.64-9.91-24.71-9.9-10.08-24.53-10.08-14.64 0-24.72 9.9-10.08 9.9-10.08 24.54 0 14.64 9.91 24.71 9.9 10.08 24.53 10.08ZM448-435.85h66v-246h-66v246ZM480.13-88q-81.31 0-152.89-30.86-71.57-30.86-124.52-83.76-52.95-52.9-83.83-124.42Q88-398.55 88-479.87q0-81.56 30.92-153.37 30.92-71.8 83.92-124.91 53-53.12 124.42-83.48Q398.67-872 479.87-872q81.55 0 153.35 30.34 71.79 30.34 124.92 83.42 53.13 53.08 83.49 124.84Q872-561.64 872-480.05q0 81.59-30.34 152.83-30.34 71.23-83.41 124.28-53.07 53.05-124.81 84Q561.7-88 480.13-88Z"/></svg> 
  );
}
