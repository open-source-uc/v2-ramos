...
export default function Hotfix(): JSX.Element {
	return (
		<>
			...
			<section className="tablet:py-20 mx-auto max-w-6xl px-4 py-16">
				...
				<div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
					...
					<div className="border-border bg-card rounded-md border p-6 transition-shadow duration-300 hover:shadow-lg">
						...
						<p className="text-muted-foreground">
							Carga Académica, asistencia requerida y más datos. Toda la información que necesitas
							en un solo lugar.
						</p>
					</div>
					...
					<div className="border-border bg-card rounded-md border p-6 transition-shadow duration-300 hover:shadow-lg">
						<div className="mb-4 flex items-center gap-3">
							<div className="bg-pink-light text-pink border-pink/20 rounded-lg border p-3">
								<ResourcesIcon className="h-6 w-6 fill-current" />
							</div>
							<h3 className="text-xl font-semibold">Recursos Académicos</h3>
						</div>
						<p className="text-muted-foreground">
							Accede a materiales de estudio, recomendaciones y recursos compartidos por la
			...
			<section className="tablet:py-20 mx-auto max-w-6xl px-4 py-16">
				...
				<div className="grid grid-cols-1 gap-6 md:grid-cols-3">
					<div className="bg-accent border-border hover:border-green/30 group rounded-md border p-6 transition-all duration-300">
						<div className="mb-4 flex items-center gap-3">
						...
						<div className="text-muted-foreground mb-4 text-sm">
							Utiliza nuestro buscador inteligente para encontrar el curso que te interesa. Busca
							por nombre o sigla.
						</div>
					...
					<div className="bg-accent border-border hover:border-blue/30 group rounded-md border p-6 transition-all duration-300">
						<div className="mb-4 flex items-center gap-3">
					...
					<div className="bg-accent border-border hover:border-pink/30 group rounded-md border p-6 transition-all duration-300">
						<div className="mb-4 flex items-center gap-3">
							<div className="bg-pink-light text-pink border-pink/20 rounded-lg border p-2 transition-transform duration-300 group-hover:scale-110">
						...
						<div className="text-muted-foreground mb-4 text-sm">
							Después de cursar tu ramo, ayuda a otros estudiantes compartiendo tu experiencia y
							tips en una reseña.
						</div>
						<div className="text-pink flex items-center gap-2 text-xs font-medium">
							<div className="bg-pink h-2 w-2 rounded-full"></div>
			...
			<section className="tablet:py-20 py-16">
				<div className="mx-auto max-w-6xl px-4">
					<div className="mb-12 text-center">
						...
						<p className="text-muted-foreground text-lg">
							Encuentra cursos organizados por área de estudio
						</p>
					</div>

					<div className="tablet:gap-4 mb-8 flex flex-wrap justify-center gap-3">
						<Pill variant="blue" size="lg" icon={ResearchIcon}>
							Ciencias
						</Pill>
						<Pill variant="pink" size="lg" icon={ArtIcon}>
							Artes
						</Pill>
						<Pill variant="orange" size="lg" icon={WorkloadIcon}>
							Economía y Administración
						</Pill>
						<Pill variant="green" size="lg" icon={HumanityIcon}>
							Humanidades
						</Pill>
						<Pill variant="purple" size="lg" icon={MedicineIcon}>
							Medicina
						</Pill>
					</div>
					...
					<div className="text-center">
						<Button
							...
							variant="outline"
							size="lg"
							aria-label="Ver todas las categorías de cursos"
						>
